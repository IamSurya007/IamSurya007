...
I love turning ideas into clean, efficient code and constantly exploring modern frameworks, architectures, and tools.
...
### **Frontend**
- Angular • Ionic Framework • React.js • Next.js  
- Tailwind CSS • SCSS • Responsive UI • Component Architecture
...
### **State Management**
- RxJS • NgRx (basics) • Redux Toolkit
...
### **DevOps & Tools**
- Git • GitHub/GitLab • NPM • Webpack  
- GitLab CI/CD • Firebase Hosting • Netlify • Vercel  
- Sentry (Monitoring & Performance)
